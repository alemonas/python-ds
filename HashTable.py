# In this quiz, you'll write your own hash table and hash function that uses string
#  keys. Your table will store strings in buckets by their first two letters, 
...
# Python dictionary—only lists! And remember to store lists at each bucket, 
